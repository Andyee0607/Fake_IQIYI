    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="视频类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择视频类型" clearable>
          <el-option
            v-for="dict in dict.type.sys_iqiyi_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="videoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="视频类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_iqiyi_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('iqiyi/video/export', {
        ...this.queryParams
